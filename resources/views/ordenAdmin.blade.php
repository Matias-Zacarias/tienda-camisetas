                ...
                <!-- <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <select class="form-select status" style="width: auto; padding: 0.4rem 0.6rem;"
                                                                                                ...
                                                                                                <option value="En Proceso" ${pedido.estado==='En Proceso' ? 'selected' : '' }>
                                                                                                    En Proceso
                                                                                                </option>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="action-buttons">
                                                                                                <button class="action-btn view" title="Ver detalles" onclick="viewOrder(${pedido.id})">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <select class="form-select status warning" style="width: auto; padding: 0.4rem 0.6rem;">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <select class="form-select status info" style="width: auto; padding: 0.4rem 0.6rem;">
                                                                                                <option>Pendiente</option>
